...
function createComposerService() {
  const database = {
    ...
    2: { firstName: 'Wolfgang', lastName: 'Mozart', genre: 'Classical' },
    3: { firstName: 'Ludwig', lastName: 'Beethoven', genre: 'Classical, Romantic' },
    4: { firstName: 'Richard', lastName: 'Wagner', genre: 'Romantic' },
    5: { firstName: 'Philip', lastName: 'Glass', genre: 'Contemporary' }
  }
